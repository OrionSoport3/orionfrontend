...
export const Subboton = ({label, select } : Props) => {

    return (
        <button type="submit" name={label} onClick={() => {select()}} className="flex justify-center items-center BP1:bg-gradient-to-r BP1:from-blue-button BP1:to-black w-auto p-2 BP1:p-0 BP1:w-48 BP1:h-12 BP1:rounded-xl
