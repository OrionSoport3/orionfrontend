export const BigBoton = () => {
    return (
        <a className="flex justify-center items-center BP1:bg-gradient-to-r BP1:from-blue-button BP1:to-black w-auto p-2 h-10 BP1:w-48 BP1:h-16 rounded-xl 
