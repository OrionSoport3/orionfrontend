      ...
      {filteredDocuments.map((document: any) => (
          ...
          >
            ...
            <div className=' absolute bottom-[50%] top-[45%] right-3 space-x-1'>
              <button className='bg-[#d4d3e6] h-fit w-fit p-[3px] rounded-md' onClick={() => {onFileSelect(document), onConflictFile(!showPopWindow), onContent({ icono: '/error-circle-regular-240.png', texto1: '¿Está seguro de que desea eliminar el archivo', texto2: '?', aviso: 'Eliminar archivo'})}}>
